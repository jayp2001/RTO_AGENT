...
function DealerBookList(props) {
    ...
    React.useEffect(() => {
        dispatch(dealerBookList(page + 1, rowsPerPage, props.dealerId))
    }, [dispatch, setRowsPerPage, setPage])

    const handleChangePage = (event, newPage) => {
        setPage(newPage);
        dispatch(dealerBookList(newPage + 1, rowsPerPage, props.dealerId))
    };
    ...
    const handleChangeRowsPerPage = (event) => {
        ...
        dispatch(dealerBookList(page + 1, parseInt(event.target.value, 10), props.dealerId))
    };
